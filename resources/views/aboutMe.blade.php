...
@section('aboutme')
    <div class="postDetailsBox">
        ...
        <!-- <h3 class="ich_1"><strong>Meine Trainers und MitarbeiterInnen beschreiben mich als : </strong></h3>
        <div class="container-fluid mt-4">
            <div class="row">
                ...
                <div class="col p-3"><ins>2. WERTSCHÄTZEND </ins><br>
                    <p class="text">Ich wertschätze die Geschäftsbeziehungen zu meiner Kunden, weil mein Erfolg davon
                        abhängt.
                </div>
                ...
                <!-- <div class="row">
                            ...
                            <h2 class="title_header">ICH LERNE KONTINUIERLICH</h2><br>
                        Über Geschäftsmodelle, Daten, Technologien und Methoden. Ich teile mein Wissen und erkenne meine Fehler,
                        so dass ich  daraus lerne.
                    
                            <h2 class="title_header">ICH BIN MACHER</h2><br>
                        Ich löse Probleme und rede nicht nur davon.
                    
                            
                            <h2 class="title_header">ICH BIN FOKUSSIERT</h2><br>
